...
from texttests.script_parser import parse_commands
...
class TestParseCommandsInvalidToken:
    ...
    def test_jump_missing_y(self):
        with pytest.raises(ValueError, match="ERROR UNKNOWN_TOKEN"):
            parse_commands("Commands:\njump 50")

    def test_jump_non_numeric(self):
        with pytest.raises(ValueError, match="ERROR UNKNOWN_TOKEN"):
            parse_commands("Commands:\njump abc 50")

    def test_jump_too_many_parts(self):
        with pytest.raises(ValueError, match="ERROR UNKNOWN_TOKEN"):
            parse_commands("Commands:\njump 50 50 50")
